...
<section class="py-10 sm:py-16 bg-white">
    <div class="max-w-4xl mx-auto px-4 prose prose-base sm:prose-lg">
        ...
        <h1 class="text-3xl sm:text-4xl font-bold text-primary-700 mb-6">Terms &amp; Conditions</h1>
        ...
        <h2 class="text-xl sm:text-2xl font-bold text-primary-700 mt-8 mb-3">1. Account Registration</h2>
        ...
        <h2 class="text-xl sm:text-2xl font-bold text-primary-700 mt-8 mb-3">2. Appointments</h2>
        <ul class="list-disc list-inside space-y-2 text-gray-700">
        ...
        <h2 class="text-xl sm:text-2xl font-bold text-primary-700 mt-8 mb-3">3. Ratings</h2>
        <p class="text-gray-700 leading-relaxed mb-6">
        ...
        <h2 class="text-xl sm:text-2xl font-bold text-primary-700 mt-8 mb-3">4. Acceptable Use</h2>
        <ul class="list-disc list-inside space-y-2 text-gray-700">
        ...
        <h2 class="text-xl sm:text-2xl font-bold text-primary-700 mt-8 mb-3">5. Liability</h2>
        <p class="text-gray-700 leading-relaxed mb-6">
        ...
        <h2 class="text-xl sm:text-2xl font-bold text-primary-700 mt-8 mb-3">6. Changes to These Terms</h2>
        <p class="text-gray-700 leading-relaxed mb-6">
        ...
        <h2 class="text-xl sm:text-2xl font-bold text-primary-700 mt-8 mb-3">7. Contact</h2>
        <p class="text-gray-700 leading-relaxed mb-6">
